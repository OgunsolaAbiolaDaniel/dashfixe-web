  ...
  return (
    <section id="explore" className="scroll-mt-[88px] bg-panel">
      <div className="mx-auto max-w-[1280px] px-[clamp(18px,4vw,40px)] pb-[clamp(48px,6vw,80px)] pt-[clamp(24px,3vw,40px)]">
        <h2 className="mb-[34px] text-h2 text-ink">
            ...
            <article key={title} className="flex flex-col rounded-[20px] bg-well p-7">
              <div className="mb-[26px] flex items-start gap-5">
                <div className="min-w-0">
                  <h3 className="mb-2.5 text-h3 text-ink">{title}</h3>
                  <p className="text-[14.5px] font-medium leading-[1.55] text-ink-60 [text-wrap:pretty]">{body}</p>
                </div>
